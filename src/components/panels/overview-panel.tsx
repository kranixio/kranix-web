    ...
    >
      ...
      <div className="relative z-10 mt-8 flex flex-col items-center gap-2">
        ...
        <div className="font-mono text-[8px] uppercase tracking-widest text-os-accent/40">
          alpha-v1 // MCP-compatible // GitOps-native
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
            ...
            {recentWritings.length > 0
              ...
              : (
                  <div className="flex flex-col items-center justify-center rounded-sm border border-os-border bg-os-surface/40 p-8 text-center">
                    <span className="font-mono text-[11px] text-muted-foreground">No recent docs found.</span>
                  </div>
                )}
          </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <div>
              ...
              <div className="space-y-1">
                <QuickAction icon={FolderIcon} label="Platform modules" panelId="projects" />
                <QuickAction icon={FlaskIcon} label="Roadmap & research" panelId="experiments" />
                <QuickAction icon={CodeIcon} label="Documentation" panelId="writing" />
                <QuickAction icon={RocketLaunchIcon} label="Release activity" panelId="activity" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="rounded-sm border border-os-border bg-os-surface p-4 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-foreground">alpha-v1 Control Plane</span>
                </div>
                <p className="text-[11px] leading-relaxed text-muted-foreground">
                  Shipping the first-class MCP server, GitOps-native reconciliation with KranixApp CRDs, and multi-backend runtime drivers for Docker and Kubernetes.
                </p>
            ...
            <div>
              ...
              <div className="space-y-1">
                {[
                  ['runtime', 'Docker / K8s / Remote'],
                  ['stack', 'Go / Kubernetes / MCP'],
                  ['focus', 'AI-operable Infra'],
                  ['status', 'alpha-v1 — built in public'],
                ].map(([key, value]) => (
