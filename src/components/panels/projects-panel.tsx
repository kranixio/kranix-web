...
const PROJECTS: Project[] = [
  {
    id: 'kranix-core',
    title: 'Kranix Core',
    description: 'The reconciler engine at the heart of the platform. Continuously converges desired state to actual state across Docker, Kubernetes, and remote nodes. Full event log with queryable state transitions.',
    tags: ['reconciler', 'control-plane', 'runtime'],
    status: 'active',
    stars: 0,
    lastUpdated: '2026-05-14',
    tech: ['Go', 'Kubernetes', 'Docker'],
    commits: 0,
    url: 'https://github.com/kranixio',
  },
  {
    id: 'kranix-mcp',
    title: 'Kranix MCP Server',
    description: 'First-class MCP server exposing deploy, logs, analyze, and heal tools to AI agents. Agent permission scopes, dry-run mode, per-agent audit logging, and autonomous healing within safe boundaries.',
    tags: ['MCP', 'AI agents', 'automation'],
    status: 'in-progress',
    lastUpdated: '2026-05-14',
    tech: ['Go', 'MCP', 'OpenTelemetry'],
    commits: 0,
    url: 'https://github.com/kranixio',
  },
  {
    id: 'kranix-cli',
    title: 'Kranix CLI',
    description: 'Single CLI for all operations — deploy, logs, analyze, diff, rollback. Multi-context profiles for dev, staging, and prod. Shell completion for bash, zsh, and fish. Inline AI assistant via kranix ai.',
    tags: ['CLI', 'developer-experience'],
    status: 'in-progress',
    lastUpdated: '2026-05-14',
    tech: ['Go', 'Cobra', 'TUI'],
    commits: 0,
    url: 'https://get.kranix.io',
  },
  {
    id: 'kranix-operator',
    title: 'GitOps Operator',
    description: 'Kubernetes operator reconciling KranixApp, KranixPolicy, and KranixSecret CRDs from Git. Progressive delivery via canary and blue-green flags. Multi-cluster federation support.',
    tags: ['GitOps', 'Kubernetes', 'CRD'],
    status: 'in-progress',
    lastUpdated: '2026-05-14',
    tech: ['Go', 'controller-runtime', 'Helm'],
    commits: 0,
    url: 'https://charts.kranix.io',
  },
  {
    id: 'runtime-drivers',
    title: 'Runtime Drivers',
    description: 'Multi-backend scheduling layer — Docker, Kubernetes, Podman, and remote bare-metal nodes. Same kranix deploy command works against any backend transparently.',
    tags: ['Docker', 'Kubernetes', 'multi-backend'],
    status: 'active',
    lastUpdated: '2026-05-14',
