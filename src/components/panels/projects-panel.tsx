...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'Shared domain types, errors, and auth primitives imported by core and api. Includes kranix-mock-api for local client development without a running control plane.',
    tags: ['shared', 'types', 'mock'],
    status: 'shipped',
    lastUpdated: '2026-05-19',
    tech: ['Go', 'Types', 'Mock API'],
    commits: 0,
