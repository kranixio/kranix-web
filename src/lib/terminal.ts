...
export function getBootLines(): TerminalLine[] {
  return [
    ...
    createLine('system', ''),
    createLine('system', 'Kranix Control Plane v0.1.0 (alpha-v1) loaded.'),
    createLine('system', 'Reconciler online. MCP server ready.'),
    createLine('system', ''),
...
const commands: Record<string, CommandHandler> = {
  help: (_args, ctx) => {
    ctx.addLines([
      createLine('output', '┌──────────────────────────────────────────────┐'),
      createLine('output', '│  KRANIX — Command Reference                  │'),
      createLine('output', '├──────────────┬───────────────────────────────┤'),
      ...
      createLine('output', '│  about       │  About Kranix IO              │'),
      createLine('output', '└──────────────┴───────────────────────────────┘'),
    ])
  },
  ...
  whoami: (_args, ctx) => {
    ctx.addLines([
      createLine('output', '  platform: Kranix IO'),
      createLine('output', '  role:     AI-native control plane'),
  ...
  neofetch: (_args, ctx) => {
    ctx.addLines([
      createLine('output', ''),
      createLine('output', '  ██╗  ██╗   root@kranix'),
      createLine('output', '  ██║ ██╔╝   ─────────────────'),
      createLine('output', '  █████╔╝    OS:      Kranix IO alpha-v1'),
      createLine('output', '  ██╔═██╗    Kernel:  Go 1.22+'),
      createLine('output', '  ██║  ██╗   Shell:   kranix-sh 1.0'),
      createLine('output', '  ╚═╝  ╚═╝   MCP:     compatible'),
      createLine('output', '             GitOps:  native'),
      createLine('output', ''),
    ])
  },
  ...
  about: (_args, ctx) => {
    ctx.addLines([
      createLine('output', ''),
      createLine('output', '  Kranix IO — AI-native Control Plane'),
      createLine('output', '  ────────────────────────────────────'),
      createLine('output', '  Open-source infrastructure runtime for'),
      createLine('output', '  containers and clusters. MCP-compatible.'),
      createLine('output', '  GitOps-native. Built for humans and AI agents.'),
      createLine('output', ''),
      createLine('output', '  https://kranix.prodevopsguytech.com'),
      createLine('output', '  License: Apache 2.0'),
      createLine('output', ''),
    ])
  },
